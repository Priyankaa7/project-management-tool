            ...
            <div className="w-fit z-10 lg:w-1/4 p-4  flex flex-col justify-center items-center bg-[#101113] rounded-2xl border-2 border-white/5 space-y-10">
                ...
                <div className="space-y-5 lg:w-full">
                    <div className="w-full space-y-2">
                        ...
                        <input className="w-full p-2 text-primary_text outline-none focus:border-white/50 rounded bg-transparent border-[1px] border-white/10" onChange={e=> setEmail(e.target.value)} name="firstName" placeholder="enter your first name" type="text" />
                    </div>
                    <div className="w-full space-y-2">
                        <label className="text-form_text">Password</label>
                        <input name="lastName" className="w-full  p-2 text-primary_text outline-none focus:border-white/50 rounded bg-transparent border-[1px] border-white/10" onChange={e=> setPassword(e.target.value)} placeholder="enter your last name" type="text" />
                    </div>
